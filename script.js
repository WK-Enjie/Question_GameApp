...
async function submitPin() {
    ...
    console.log('Loading:', folder + gameState.currentPin + '.json');
    ...
    try {
        ...
        await loadQuestions(`questions/${folder}${gameState.currentPin}.json`);
...
function checkElements() {
    ...
    console.log('pinScreen:', pinScreen);
    console.log('pinButtons:', pinButtons.length);
    console.log('clearBtn:', clearBtn);
    console.log('submitPinBtn:', submitPinBtn);
}
